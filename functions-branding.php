...
// AndrewRMinion branding
    ...
    function remove_footer_admin() {
        echo '&copy; ' . date( 'Y' ) . ' by <a href="https://andrewrminion.com/?utm_source=client-site&utm_content=admin-copyright&utm_campaign=gatewaybaptist.church" target="_blank">AndrewRMinion Design</a>.';
    }
    ...
    function armd_dashboard_widget_function() {
        ...
        <li>Developer: <a href=\"https://andrewrminion.com/?utm_source=client-site&utm_content=admin-details&utm_campaign=gatewaybaptist.church\" target=\"_blank\">AndrewRMinion Design</a></li>
